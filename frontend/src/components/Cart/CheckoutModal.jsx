...
export default function CheckoutModal({ open, onClose, onOrderCreated }) {
  ...
  return <div className="fixed inset-0 z-50 flex items-end bg-black/45 p-0 sm:items-center sm:p-5" role="dialog" aria-modal="true" aria-labelledby="checkout-title">
