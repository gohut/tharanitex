      ...
      <div className="mx-auto grid max-w-[1180px] gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16 xl:gap-24">
        ...
        <div className="flex items-center justify-center">
          <div className="flex max-w-[470px] flex-col items-center text-center">
            ...
            <h2 className="mt-7 whitespace-pre-line font-klaristha text-[4.4rem] leading-[0.98] tracking-[-0.03em] text-[#111111] sm:text-[5.4rem] lg:text-[6.25rem]">
            ...
            {content.subtitle && (
              <p className="mt-9 max-w-[430px] whitespace-pre-line font-montserrat text-[1.05rem] font-normal leading-[1.42] text-[#1e1e1e] sm:text-[1.15rem] lg:text-[1.3rem]">
                {content.subtitle}
              </p>
            )}
