          ...
          {isSearchMode ? (
            <>
              <div className="flex shrink-0 items-center gap-2 md:gap-3">
                ...
                <Link href="/home" aria-label="Go to home" className="shrink-0">
                  <img
                    src="/assets/logo.png"
              ...
              <div className="order-3 basis-full relative w-full md:order-none md:col-start-2 md:row-start-1 md:mx-auto md:w-[min(36vw,440px)] md:basis-auto">
                ...
                />
                {navbarSearch && (
                  <button type="button" aria-label="Clear search" onClick={() => updateNavbarSearch("")} className="absolute right-0 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center text-[#2F2B27]">
                    <X size={18} />
                  </button>
                )}
              ...
              <div className="ml-auto flex shrink-0 items-center gap-1 md:col-start-3 md:row-start-1 md:justify-self-end md:gap-5 lg:gap-7">
                <button aria-label="Wishlist" onClick={() => router.push("/wishlist")} className="flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:bg-[#F1E6D5] hover:scale-105 active:scale-95">
                  <img src="/assets/wishlist_icon.png" alt="Wishlist" className="h-6 w-6 object-contain md:h-7 md:w-7" draggable={false} />
                </button>
                <button aria-label="Cart" onClick={() => router.push("/cart")} className="flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:bg-[#F1E6D5] hover:scale-105 active:scale-95">
                  <ShoppingBag size={22} strokeWidth={1.8} className="text-[#2F2B27]" />
                </button>
                <button type="button" aria-label="Close search" onClick={closeSearchMode} className="flex h-10 w-10 items-center justify-center text-[#2F2B27] transition hover:bg-[#F1E6D5]">
                  <X size={22} />
                </button>
              </div>
            </>
