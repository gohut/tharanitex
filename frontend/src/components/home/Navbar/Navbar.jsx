  ...
  return (
    <>
      <header className="sticky top-0 z-50 h-16 w-full border-b border-[#E8DCC8] bg-[#F8F2E8]/95 backdrop-blur-md md:h-[78px]">
        ...
        {/* Normal Header Mode */}
        <div className="relative mx-auto flex h-full max-w-[1440px] items-center px-4 md:px-8 lg:px-10 grid grid-cols-[1fr_auto_1fr]">
            ...
            <div className="md:hidden">
              {pathname === "/" || pathname === "/home" ? (
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:bg-[#F1E6D5] active:scale-95"
                >
                  <ArrowLeft size={24} strokeWidth={1.8} className="text-[#2F2B27]" />
                </button>
              )}
            </div>
          ...
          {/* LOGO */}
          <div className="absolute left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 md:static md:z-auto md:flex-1 md:translate-x-0 md:translate-y-0 md:justify-start">
            <Link href="/home" aria-label="Go to home">
              <img
                src="/assets/logo.png"
                alt="Tharani Textiles"
                className="h-8 w-auto max-w-[105px] object-contain transition-transform duration-300 hover:scale-[1.02] md:h-[60px] md:max-w-none"
                draggable={false}
              />
            </Link>
          </div>
          ...
          <div className="ml-auto flex shrink-0 items-center gap-0 md:gap-5 lg:gap-7">
            <button
              type="button"
              aria-label="Search"
