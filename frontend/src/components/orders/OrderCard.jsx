...
export default function OrderCard({ order }) {
  ...
  return (
  <div className="block border border-[#DDCFBD] bg-[#FCF7EF] p-5 transition hover:-translate-y-0.5 hover:shadow-sm md:p-6">
      ...
      <Link
        ...
        className="mt-5 grid grid-cols-[96px_minmax(0,1fr)] gap-4 border-t border-[#E7DAC8] pt-5 sm:grid-cols-[120px_minmax(0,1fr)] sm:gap-5 lg:mt-6 lg:grid-cols-[120px_1fr_auto] lg:items-center"
      >
        ...
        <div className="col-span-2 flex flex-col items-end gap-2.5 justify-self-stretch pt-1 lg:col-span-1 lg:justify-self-end lg:pt-0">
          ...
          {firstItem?.slug && (
            <Link
              ...
              className="inline-flex min-h-11 w-full items-center justify-center gap-3 border border-[#CDBCA2] px-5 py-3 text-[15px] font-semibold text-[#231F1A] transition hover:border-[#E0A22E] hover:text-[#E0A22E] lg:w-auto lg:px-6 lg:py-4 lg:text-[17px]"
            >
              <ShoppingBag size={20} />
              <span>Buy Again</span>
            </Link>
