          ...
          {activeTab === "signin" ? (
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-[#E8DCC8] bg-white rounded-xl py-3.5 text-sm font-semibold text-[#2F2B27] hover:border-[#C79A2B] hover:bg-[#FDFBF7] transition shadow-sm"
              >
