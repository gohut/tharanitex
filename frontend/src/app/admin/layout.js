...
export default function AdminLayout({ children }) {
  ...
  const handleLogout = async () => {
    ...
    try {
      if (typeof document !== "undefined") {
        document.cookie = "tharanitex_session=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
  ...
  const adminName = adminUser?.fullName || adminUser?.name || "Super Admin";
  const adminEmail = adminUser?.email || "admin@tharanitextiles.com";
  const adminRole = adminUser?.roleName || adminUser?.role || "Super Admin";
        ...
        <div className="px-3 py-4 border-t border-green-800">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-green-400 text-xs truncate">{adminRole}</p>
            </div>
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden sm:block text-white text-xs font-medium">{adminName.split(" ")[0]}</span>
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 bg-green-800 border border-green-700 rounded-xl shadow-card-hover animate-fade-in overflow-hidden z-50">
                  <div className="px-4 py-3 border-b border-green-700">
                    ...
                    <p className="text-green-400 text-xs">{adminEmail}</p>
                  </div>
                  <Link
                    href="/admin/settings"
